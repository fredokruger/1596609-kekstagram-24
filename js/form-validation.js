...
const successSendContainer = document.querySelector('#success').content.querySelector('.success');
const errorSendContainer = document.querySelector('#error').content.querySelector('.error');
const successButton = successSendContainer.querySelector('.success__button');
const errorButton = errorSendContainer.querySelector('.error__button');
...
const onSuccessMessageEvent = (evt) => {
  ...
  successSendContainer.remove();
  successSendContainer.removeEventListener('click', onSuccessMessageEvent);
  document.removeEventListener('keydown', onSuccessMessageEvent);
};

//Функция открытия окна ошибки отправки фото
const openErrorMessage = () => {
  body.append(errorSendContainer);
...
const openSuccessMessage = () => {
  body.append(successSendContainer);
  successSendContainer.addEventListener('click', onSuccessMessageEvent);
